...
CREATE TABLE `acl_permission` (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '路由名称或接口名称',
  `path` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '菜单路径(以http开头时，视为打开外部链接) 或 请求接口的地址',
  `component` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '菜单组件，只有叶子菜单才可配置',
  `meta` varchar(1023) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '菜单的route.meta配置项，json格式',
...
CREATE TABLE `acl_user` (
  ...
  `nickname` varchar(31) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '昵称',
  `avatar` varchar(1023) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '用户头像',
  `mark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '备注',
  `sign` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '用户签名',
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='管理员用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `edu_chapter` (
  ...
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=COMPACT COMMENT='课程章节表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=COMPACT COMMENT='课程章节临时表（用于存放二次修改的数据）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `edu_comment` (
  ...
  `content` varchar(1023) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '评论内容',
...
) ENGINE=InnoDB AUTO_INCREMENT=651 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='课程评论表';
/*!40101 SET character_set_client = @saved_cs_client */;
--
...
CREATE TABLE `edu_course` (
  ...
  `description` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '课程描述',
  ...
  `remarks` varchar(511) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=COMPACT COMMENT='课程表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=COMPACT COMMENT='课程科目分类表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `edu_teacher` (
  ...
  `email` varchar(127) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '邮箱地址',
  `password` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '密码',
  ...
  `avatar` varchar(1023) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '讲师头像',
  `resume` varchar(1023) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '讲师简历链接',
...
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='讲师表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `edu_video` (
  ...
  `duration` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '0' COMMENT '视频时长（秒）',
...
) ENGINE=InnoDB AUTO_INCREMENT=257 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=COMPACT COMMENT='课程视频';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `edu_video_tmp` (
  ...
  KEY `idx_chapter_id` (`chapter_id`) USING BTREE,
  KEY `idx_id` (`oid`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=COMPACT COMMENT='课程视频表（用于存放二次修改的数据）';
/*!40101 SET character_set_client = @saved_cs_client */;
--
...
CREATE TABLE `hm_banner` (
  ...
  `title` varchar(63) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '标题',
  `image_url` varchar(1023) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '图片地址',
  `link_url` varchar(1023) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '链接地址',
  `sort` int unsigned NOT NULL DEFAULT '0' COMMENT '排序',
  `enable` tinyint unsigned NOT NULL DEFAULT '1' COMMENT '是否启用，0否1是',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='首页banner表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='课程订阅-学员关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_message` (
  ...
  `title` varchar(127) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '消息标题',
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='消息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_order` (
  ...
  `transaction_num` varchar(31) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '交易流水号',
...
CREATE TABLE `uctr_member` (
  ...
  `avatar` varchar(1023) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '用户头像',
  `sign` varchar(127) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '用户签名',
  `enable` tinyint(1) DEFAULT '1' COMMENT '是否启用，0否1是',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=1203 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci ROW_FORMAT=DYNAMIC COMMENT='会员表';
/*!40101 SET character_set_client = @saved_cs_client */;
